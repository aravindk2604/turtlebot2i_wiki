# -*- coding: utf-8 -*-
#
# TurtleBot2i documentation build configuration file, created by
...
html_logo = '_static/logo_tb2i.jpeg'
...
htmlhelp_basename = 'TurtleBot2idoc'
...
latex_documents = [
    (master_doc, 'TurtleBot2i.tex', u'TurtleBot2i Documentation',
...
man_pages = [
    (master_doc, 'TurtleBot2i', u'TurtleBot2i Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TurtleBot2i', u'TurtleBot2i Documentation',
     author, 'TurtleBot2i', 'One line description of project.',
     'Miscellaneous'),
]
...
pdf_documents = [
        ('contents', u'TurtleBot2i', u'TurtleBot2i', u'Dabit Industries')
]
